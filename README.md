...
The React web client for Big Star Transit's operations platform. It provides the authenticated Dashboard, Master Run Cuts, Deployment, Network Success Excel Submissions and Performance analysis, an auditable route-reallocation approval workflow, bidirectional Deployment/Network Success posts with replies and notifications, ELT Reporting, Leaderboard, Settings, and User Administration interfaces.
